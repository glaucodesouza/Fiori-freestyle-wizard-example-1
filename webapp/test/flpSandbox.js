		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori-freestyle-Wizard-v1",
									"targetURL": "#fiorifreestylewizardv1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorifreestylewizardv1-display": {
								"semanticObject": "fiorifreestylewizardv1",
								"action": "display",
								"description": "Fiori-freestyle-Wizard-v1",
								"title": "Fiori-freestyle-Wizard-v1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorifreestylewizardv1",
									"url": sap.ui.require.toUrl("fiorifreestylewizardv1")
								}
							}
						}
					}
